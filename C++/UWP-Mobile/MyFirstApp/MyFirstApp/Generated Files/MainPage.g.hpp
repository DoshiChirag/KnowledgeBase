...
void ::MyFirstApp::MainPage::InitializeComponent()
{
    ...
    // Get the Grid named 'DataGrid'
    DataGrid = safe_cast<::Windows::UI::Xaml::Controls::Grid^>(static_cast<Windows::UI::Xaml::IFrameworkElement^>(this)->FindName(L"DataGrid"));
    ...
    // Get the GridView named 'list'
    list = safe_cast<::Windows::UI::Xaml::Controls::GridView^>(static_cast<Windows::UI::Xaml::IFrameworkElement^>(this)->FindName(L"list"));
